...
class yc_oauth2_info_mec_app_descriptor__app_descriptor_transport_dependency_transport_security_oauth2_info(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module mec-app-descriptor - based on the path /app-descriptor/transport-dependency/transport/security/oauth2-info. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['app-descriptor', 'transport-dependency', 'transport', 'security', 'oauth2-info']

  def _get_grant_types(self):
    """
    Getter method for grant_types, mapped from YANG variable /app_descriptor/transport_dependency/transport/security/oauth2_info/grant_types (enumeration)
  ...
  def _set_grant_types(self, v, load=False):
    """
    Setter method for grant_types, mapped from YANG variable /app_descriptor/transport_dependency/transport/security/oauth2_info/grant_types (enumeration)
    If this variable is read-only (config: false) in the
  ...
  def _get_token_endpoint(self):
    """
    Getter method for token_endpoint, mapped from YANG variable /app_descriptor/transport_dependency/transport/security/oauth2_info/token_endpoint (inet:uri)
  ...
  def _set_token_endpoint(self, v, load=False):
    """
    Setter method for token_endpoint, mapped from YANG variable /app_descriptor/transport_dependency/transport/security/oauth2_info/token_endpoint (inet:uri)
    If this variable is read-only (config: false) in the
...
class yc_security_mec_app_descriptor__app_descriptor_transport_dependency_transport_security(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module mec-app-descriptor - based on the path /app-descriptor/transport-dependency/transport/security. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  ...
  def __init__(self, *args, **kwargs):
    ...
    self._extmethods = False
    self.__oauth2_info = YANGDynClass(base=yc_oauth2_info_mec_app_descriptor__app_descriptor_transport_dependency_transport_security_oauth2_info, is_container='container', yang_name="oauth2-info", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://example.com/ns/mec-app-descriptor', defining_module='mec-app-descriptor', yang_type='container', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['app-descriptor', 'transport-dependency', 'transport', 'security']

  def _get_oauth2_info(self):
    """
    Getter method for oauth2_info, mapped from YANG variable /app_descriptor/transport_dependency/transport/security/oauth2_info (container)
  ...
  def _set_oauth2_info(self, v, load=False):
    """
    Setter method for oauth2_info, mapped from YANG variable /app_descriptor/transport_dependency/transport/security/oauth2_info (container)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=yc_oauth2_info_mec_app_descriptor__app_descriptor_transport_dependency_transport_security_oauth2_info, is_container='container', yang_name="oauth2-info", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://example.com/ns/mec-app-descriptor', defining_module='mec-app-descriptor', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """oauth2_info must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=yc_oauth2_info_mec_app_descriptor__app_descriptor_transport_dependency_transport_security_oauth2_info, is_container='container', yang_name="oauth2-info", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://example.com/ns/mec-app-descriptor', defining_module='mec-app-descriptor', yang_type='container', is_config=True)""",
        })
...
class yc_transport_mec_app_descriptor__app_descriptor_transport_dependency_transport(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module mec-app-descriptor - based on the path /app-descriptor/transport-dependency/transport. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['app-descriptor', 'transport-dependency', 'transport']

  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /app_descriptor/transport_dependency/transport/name (string)
  ...
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /app_descriptor/transport_dependency/transport/name (string)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_name is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_name() directly.
  ...
  def _get_description(self):
    """
    Getter method for description, mapped from YANG variable /app_descriptor/transport_dependency/transport/description (string)
  ...
  def _set_description(self, v, load=False):
    """
    Setter method for description, mapped from YANG variable /app_descriptor/transport_dependency/transport/description (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_type(self):
    """
    Getter method for type, mapped from YANG variable /app_descriptor/transport_dependency/transport/type (transport-type)
  ...
  def _set_type(self, v, load=False):
    """
    Setter method for type, mapped from YANG variable /app_descriptor/transport_dependency/transport/type (transport-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_protocol(self):
    """
    Getter method for protocol, mapped from YANG variable /app_descriptor/transport_dependency/transport/protocol (string)
  ...
  def _set_protocol(self, v, load=False):
    """
    Setter method for protocol, mapped from YANG variable /app_descriptor/transport_dependency/transport/protocol (string)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_protocol is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_protocol() directly.
  ...
  def _get_version(self):
    """
    Getter method for version, mapped from YANG variable /app_descriptor/transport_dependency/transport/version (string)
  ...
  def _set_version(self, v, load=False):
    """
    Setter method for version, mapped from YANG variable /app_descriptor/transport_dependency/transport/version (string)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_version is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_version() directly.
  ...
  def _get_security(self):
    """
    Getter method for security, mapped from YANG variable /app_descriptor/transport_dependency/transport/security (container)
  ...
  def _set_security(self, v, load=False):
    """
    Setter method for security, mapped from YANG variable /app_descriptor/transport_dependency/transport/security (container)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=yc_security_mec_app_descriptor__app_descriptor_transport_dependency_transport_security, is_container='container', yang_name="security", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://example.com/ns/mec-app-descriptor', defining_module='mec-app-descriptor', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """security must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=yc_security_mec_app_descriptor__app_descriptor_transport_dependency_transport_security, is_container='container', yang_name="security", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://example.com/ns/mec-app-descriptor', defining_module='mec-app-descriptor', yang_type='container', is_config=True)""",
        })
...
class yc_transport_dependency_mec_app_descriptor__app_descriptor_transport_dependency(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module mec-app-descriptor - based on the path /app-descriptor/transport-dependency. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  ...
  _yang_name = 'transport-dependency'
  _yang_namespace = 'http://example.com/ns/mec-app-descriptor'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['app-descriptor', 'transport-dependency']

  def _get_id(self):
    """
    Getter method for id, mapped from YANG variable /app_descriptor/transport_dependency/id (string)
  ...
  def _set_id(self, v, load=False):
    """
    Setter method for id, mapped from YANG variable /app_descriptor/transport_dependency/id (string)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_id is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_id() directly.
  ...
  def _get_transport(self):
    """
    Getter method for transport, mapped from YANG variable /app_descriptor/transport_dependency/transport (container)
  ...
  def _set_transport(self, v, load=False):
    """
    Setter method for transport, mapped from YANG variable /app_descriptor/transport_dependency/transport (container)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=yc_transport_mec_app_descriptor__app_descriptor_transport_dependency_transport, is_container='container', yang_name="transport", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://example.com/ns/mec-app-descriptor', defining_module='mec-app-descriptor', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """transport must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=yc_transport_mec_app_descriptor__app_descriptor_transport_dependency_transport, is_container='container', yang_name="transport", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://example.com/ns/mec-app-descriptor', defining_module='mec-app-descriptor', yang_type='container', is_config=True)""",
        })
  ...
  def _get_serializers(self):
    """
    Getter method for serializers, mapped from YANG variable /app_descriptor/transport_dependency/serializers (serializer-type)
  ...
  def _set_serializers(self, v, load=False):
    """
    Setter method for serializers, mapped from YANG variable /app_descriptor/transport_dependency/serializers (serializer-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_labels(self):
    """
    Getter method for labels, mapped from YANG variable /app_descriptor/transport_dependency/labels (string)
  ...
  def _set_labels(self, v, load=False):
    """
    Setter method for labels, mapped from YANG variable /app_descriptor/transport_dependency/labels (string)
    If this variable is read-only (config: false) in the
...
class yc_service_produced_mec_app_descriptor__app_descriptor_service_produced(PybindBase):
  ...
  YANG Description: Describes services a MEC application is able to produce to the platform or other MEC applications. Only relevant for service producing apps.
  """
...
class yc_app_descriptor_mec_app_descriptor__app_descriptor(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_path_helper', '_extmethods', '__id','__name','__provider','__soft_version','__version','__mec_version','__info_name','__description','__network_policy','__sw_image','__dns_rule','__latency','__virtual_storage','__user_context_transfer_capability','__feature_dependency','__change_app_instance_state_op_config','__terminate_app_instance_op_config','__traffic_rule','__transport_dependency','__ext_cpd','__service_required','__service_produced',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__transport_dependency = YANGDynClass(base=YANGListType("id",yc_transport_dependency_mec_app_descriptor__app_descriptor_transport_dependency, yang_name="transport-dependency", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='id', extensions=None), is_container='list', yang_name="transport-dependency", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://example.com/ns/mec-app-descriptor', defining_module='mec-app-descriptor', yang_type='list', is_config=True)
  ...
  def _get_transport_dependency(self):
    """
    Getter method for transport_dependency, mapped from YANG variable /app_descriptor/transport_dependency (list)

    YANG Description: List of transport dependencies
    """
    return self.__transport_dependency
      
  def _set_transport_dependency(self, v, load=False):
    """
    Setter method for transport_dependency, mapped from YANG variable /app_descriptor/transport_dependency (list)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_transport_dependency is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_transport_dependency() directly.
    ...
    try:
      ...
      raise ValueError({
          'error-string': """transport_dependency must be of a type compatible with list""",
          'defined-type': "list",
          'generated-type': """YANGDynClass(base=YANGListType("id",yc_transport_dependency_mec_app_descriptor__app_descriptor_transport_dependency, yang_name="transport-dependency", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='id', extensions=None), is_container='list', yang_name="transport-dependency", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://example.com/ns/mec-app-descriptor', defining_module='mec-app-descriptor', yang_type='list', is_config=True)""",
        })

    self.__transport_dependency = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_transport_dependency(self):
    self.__transport_dependency = YANGDynClass(base=YANGListType("id",yc_transport_dependency_mec_app_descriptor__app_descriptor_transport_dependency, yang_name="transport-dependency", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='id', extensions=None), is_container='list', yang_name="transport-dependency", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://example.com/ns/mec-app-descriptor', defining_module='mec-app-descriptor', yang_type='list', is_config=True)
  ...
  transport_dependency = __builtin__.property(_get_transport_dependency, _set_transport_dependency)
  ...
  _pyangbind_elements = OrderedDict([('id', id), ('name', name), ('provider', provider), ('soft_version', soft_version), ('version', version), ('mec_version', mec_version), ('info_name', info_name), ('description', description), ('network_policy', network_policy), ('sw_image', sw_image), ('dns_rule', dns_rule), ('latency', latency), ('virtual_storage', virtual_storage), ('user_context_transfer_capability', user_context_transfer_capability), ('feature_dependency', feature_dependency), ('change_app_instance_state_op_config', change_app_instance_state_op_config), ('terminate_app_instance_op_config', terminate_app_instance_op_config), ('traffic_rule', traffic_rule), ('transport_dependency', transport_dependency), ('ext_cpd', ext_cpd), ('service_required', service_required), ('service_produced', service_produced), ])
